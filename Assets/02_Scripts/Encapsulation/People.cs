...
public class People : MonoBehaviour
{
    ...
    // 은닉화: 객체의 속성을 외부엥서 직접 접근하지 못하도록 제한하는 개념
    // 캡슐화:
    // 데이터(속성)와 데이터를 처리하는 행위(메서드)를 하나로 묶는 것
    // 먼저 속성을 은닉화하고 행위를 통해 속성을 접근/수정 하게 함으로사
    ...
    // 멤버 변수 은닉화/캡슐화 문제점
    // 속성을 많이 선언할수록 Get/Set 과 같은 메소드가 많아지고, (코드량이 많아지므로 귀찮다...)
