...
public class Example15 : MonoBehaviour
{
    ...
    {
        // 데이터의 형 변환
        // -> 변수에 담겨있는 데이터를 다른 데이터 타입(자료형)의 변수에 옮겨 담는 것
        ...
        // 1-1. 옮겨 담는 자료형이 더작고, 값의 범위를 넘어섰을때
        intValue = 130;
        ...
        // 4. 숫자를 문자로 형변환
        // ToString() 메소드를 이용 (메소드란 함수 또는 기능이라는 의미를 가지고 있음)
        int intValue3 = 10;
        ...
        // 5. 문자열을 숫자로 형변환
        // 5-1. Parse() 메소드를 이용
        // 사용자로부터 얻은 문자를 숫자로 변환하는 것이 특히 오류가 많이 난다.
        ...
        string stringValue6 = "4352하하하하하하호호";
        int intValue6;
