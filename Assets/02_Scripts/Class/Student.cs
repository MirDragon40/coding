...
public class Student : MonoBehaviour
{
    ...
    public string Name;
    public int Age;
    private float _weight;     // 지역변수는 소문자, 퍼블릭 변수는 대문자로 시작
    ...
    // 기본 생성자: 매개 변수가 없는 생성자는 다른 생성자가 없을 경우 자동으로 생성된다.
    ...
    public Student(string name, int age, float weight)  // 생성할 때 가져오면서 한 번 초기화를 해주겠다는 의미
    {
        Name = name;
        Age = age;
        _weight = weight;
